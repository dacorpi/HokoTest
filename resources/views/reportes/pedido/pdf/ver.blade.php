    ...
    <div class="cabecera">
            ...
            <tr>
                <td>
                    <table width="100%" cellspacing="0" cellspacing="1" align="center">
                        <tr>
                            <td align="center">
                                <img src="{{$logo}}" alt="Sistema Hoko" class="logo" width="210" height="90">
                            </td>
                        </tr>
                        <tr>
                            <td align="center">
                ...
                <td>
                    <table width="100%" cellspacing="0" cellspacing="1" align="center">
                        <tr>
                            ...
                            <td align="center">{{$rpta1[0]->nNumeroPedido}}</td>
                        </tr>
                        <tr>
                            <td align="center"><strong>Fecha Pedido</strong></td>
                            <td align="center">{{$rpta1[0]->dFechaPedido}}</td>
                        </tr>
                        <tr>
                            <td align="center"><strong>Estado Pedido</strong></td>
                            <td align="center">{{$rpta1[0]->cEstadoPedido}}</td>
                        </tr>
                        <tr>
                            <td align="center"><strong>Vendedor<strong></td>
                            <td align="center"><u>{{$rpta1[0]->cVendedor}}</u></td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <table width="100%" cellspacing="0" cellspacing="1" border="1" align="center">
            ...
            <tr>
                ...
                <td align="center">{{$rpta1[0]->cCliente}}</td>
            </tr>
            <tr>
                <td align="center"><strong>Cedula</strong></td>
                <td align="center">{{$rpta1[0]->cDocumento}}</td>
            </tr>
            <tr>
                <td align="center"><strong>Correo Electronico</strong></td>
                <td align="center">{{$rpta1[0]->cCorreo}}</td>
            </tr>
            <tr>
                <td align="center"><strong>Teléfono</strong></td>
                <td align="center">{{$rpta1[0]->cTelefono}}</td>
            </tr>
        </table>

        @if (count($rpta2) > 0)
            <table width="100%" cellspacing="0" cellspacing="1" border="1" align="center">
                <thead style="background-color: rgb(122, 122, 251);">
                    <tr align="center" align="middle">
                        <th colspan="5">Detalle del Servicio</th>
                    </tr>
                    <tr>
                        <th>#</th>
                        <th>Producto</th>
